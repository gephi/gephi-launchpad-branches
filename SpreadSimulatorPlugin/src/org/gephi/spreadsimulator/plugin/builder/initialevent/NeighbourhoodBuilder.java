...
import org.gephi.spreadsimulator.plugin.initialevent.Neighbourhood;
...
public class NeighbourhoodBuilder implements InitialEventBuilder {
	@Override
	public String getName() {
		return NbBundle.getMessage(Neighbourhood.class, "Neighbourhood.name");
	}

	@Override
	public InitialEvent getInitialEvent(String params) {
		return new Neighbourhood(params);
	}
