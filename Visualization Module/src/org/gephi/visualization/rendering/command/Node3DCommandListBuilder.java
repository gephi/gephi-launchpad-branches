 ...
 */
public final class Node3DCommandListBuilder implements CommandListBuilder<Node> {
    private final CommandListBuilder<VizNode3D> builder;
    private final AtomicReference<NodeStyler> styler;
    private NodeStyler currentStyler;

    public Node3DCommandListBuilder(CommandListBuilder<VizNode3D> builder, NodeStyler styler) {
