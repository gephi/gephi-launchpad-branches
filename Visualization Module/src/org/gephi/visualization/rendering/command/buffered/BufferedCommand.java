 ...
 */
public class BufferedCommand implements Command {
    
    private final List<Buffer> buffers;
    private final Technique<Buffer> technique;

    public BufferedCommand(List<Buffer> buffers, Technique<Buffer> technique) {
