 ...
 */
public final class Edge2DCommandListBuilder implements CommandListBuilder<Edge> {
    private final CommandListBuilder<VizEdge2D> builder;
    private final AtomicReference<EdgeStyler> styler;
    private EdgeStyler currentStyler;

    public Edge2DCommandListBuilder(CommandListBuilder<VizEdge2D> builder, EdgeStyler styler) {
