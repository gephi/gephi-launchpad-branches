 ...
 */
class NodesArray2D extends NodesArray {
    ...
    public NodesArray2D(int initialCapacity) {
        this.positions = new ArrayList<Float>(2 * initialCapacity);
    ...
    public void ensureCapacity(int minCapacity) {
        this.positions.ensureCapacity(2 * minCapacity);
    ...
    public Vec3f getPositionOf(int i) {
        int s = 2*i;
        return new Vec3f(this.positions.get(s), this.positions.get(s+1), 0.0f);
    }
