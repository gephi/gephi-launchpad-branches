...
public final class Vec2M extends Vec2Base {
     ...
     *                                   elements
     */
    public Vec2M(float[] arr) throws IndexOutOfBoundsException {
        super(arr);
    }
     ...
     */
    public Vec2M(float[] arr, int i) throws IndexOutOfBoundsException {
        super(arr, i);
    }
     ...
     *
     * @param arr the array. The components are the first two components of the
     *            the array
     * @return this
     * @throws IndexOutOfBoundsException if the array has less than two elements
     */
    public Vec2M set(float[] arr) throws IndexOutOfBoundsException {
     ...
     *                                   <code>i+2</code> elements
     */
    public Vec2M set(float[] arr, int i) throws IndexOutOfBoundsException {
        return set(arr[i], arr[i+1]);
    }
