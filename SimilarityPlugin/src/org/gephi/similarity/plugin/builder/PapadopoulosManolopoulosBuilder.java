...
public class PapadopoulosManolopoulosBuilder implements SimilarityBuilder {
	@Override
	public String getName() {
		return NbBundle.getMessage(PapadopoulosManolopoulosBuilder.class, "PapadopoulosManolopoulos.name");
	}

	@Override
	public Similarity getSimilarity() {
		return new PapadopoulosManolopoulos();
	}
