...
public class BalloonTreeNodeLayoutData implements LayoutData {
        public double d = 0;         // Constant distance used to position each child node's layout circle
        public double r = 0;         // Radius of the layout circle containing the full subtree induced by this node
